    ...
    <div>
      ...
      <div className="flex justify-between w-screen -mt-16 sticky scroll-smooth">
        ...
        <div className="w-[40%] h-screen relative">
          <div className=" h-screen px-14 py-32 text-white bg-black overflow-y-scroll fixed scroll-smooth">
          <img src={pattern} alt="" className=" h-full w-full object-cover absolute top-0 left-0 opacity-5 -z-10" />
            ...
            <div className="flex items-center text-4xl font-zen mt-14">
              ...
              <div className="text-sm space-x-5 ml-10 font-normal font-openSans">
                <button className="py-[2px] px-2 border rounded-full bg-white text-black duration-300 ">
                  1 kgs
                </button>
                <KgButton kg={5} />
                <KgButton kg={10} />
