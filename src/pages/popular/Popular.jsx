...
const PopularCart = ({ image, productTitle, price }) => {
  return (
    <div className="bg-red-20 relative group bg-gray-50 pb-10">
      {/* <div className=" absolute top left-0 w-full h-[470px] rounded-full bg-black group-hover:scale-105 duration-300 opacity-0 group-hover:opacity-100"></div> */}
      ...
      <div className="text-center text-black space-y-3 relative">
        ...
        <div className="text-sm space-x-5 font-normal font-roboto m-auto ">
          <button className="py-[2px] w-14 border rounded-full bg-black text-white duration-300 ">
            1 kgs
          </button>
          <KgButton kg={5} />
          <KgButton kg={10} />
        ...
        <button className="py-3 px-12 bg-black rounded-full border-black text-white font-oswald hover:scale-110 duration-300">
          BUY NOW
        </button>
      </div>
    </div>
